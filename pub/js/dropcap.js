...
if ( xbbcode.innerHTML[0] != "<" && xbbcode.innerHTML[0] != "[" ){
  document.getElementsByClassName('definition')[0].childNodes[0].innerHTML = narrative.substr(0,1)
  ...
  var firstLetter = document.createTextNode(xbbcode.childNodes[0].textContent.substr(0,1))
